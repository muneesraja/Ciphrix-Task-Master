        ...
        <div className="w-full max-w-md space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-8">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <Shield className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 z-10" />
                        <Select onValueChange={setRole} defaultValue={role}>
                        <SelectTrigger id="role" className="pl-10 bg-[#1e293b] border-gray-700 text-white focus:ring-blue-500 h-12">
                ...
                <div className="text-center text-sm text-gray-400">
                    Already have an account? <Link to="/signin" className="text-blue-500 hover:text-blue-400 font-medium">Sign In</Link>
                </div>
            </form>
        </div>
      </div>
